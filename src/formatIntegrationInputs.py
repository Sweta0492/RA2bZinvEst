...
scaleFactorFile = TFile("~/SF_rootFiles/SearchBinVsSF_2017.root","READ")
...
for i in range(nBins) :
    ...
    if ( dataEBHisto.GetBinContent(i+1) == 0 and dataEEHisto.GetBinContent(i+1) == 0 ) :
       ...
       outputDict["trigWerr"].append(((dataEBHisto.GetBinContent(i+1)*0.00747311) + (dataEEHisto.GetBinContent(i+1)*0.0152242))/(dataEBHisto.GetBinContent(i+1)+dataEEHisto.GetBinContent(i+1) ))    
...
can.SaveAs("prediction_2017.png")
