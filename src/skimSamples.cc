...
public :
	...
	if( r == kPhotonLDP )
        ...
        fileNames["QCD_200to300"]    = "tree_QCD_HT-200to300_MC2018.root";
        fileNames["QCD_300to500"]    = "tree_QCD_HT-300to500_MC2018.root";
        fileNames["QCD_500to700"]    = "tree_QCD_HT-500to700_MC2018.root";
        fileNames["QCD_700to1000"]   = "tree_QCD_HT-700to1000_MC2018.root";
        fileNames["QCD_1000to1500"]  = "tree_QCD_HT-1000to1500_MC2018.root";
        fileNames["QCD_1500to2000"]  = "tree_QCD_HT-1500to2000_MC2018.root";
        fileNames["QCD_2000toInf"]   = "tree_QCD_HT-2000toInf_MC2018.root";
        ...
        fileNames["DY_100to200"] = "tree_DYJetsToLL_M-50_HT-100to200_MC2018.root";
        fileNames["DY_200to400"] = "tree_DYJetsToLL_M-50_HT-200to400_MC2018.root";
        fileNames["DY_400to600"] = "tree_DYJetsToLL_M-50_HT-400to600_MC2018.root";
        fileNames["DY_600toInf"] = "tree_DYJetsToLL_M-50_HT-600toInf_MC2018.root";

        fileNames["GJets0p4_100to200"] = "tree_GJets_DR-0p4_HT-100to200_MC2018.root";
        fileNames["GJets0p4_200to400"] = "tree_GJets_DR-0p4_HT-200to400_MC2018.root";
        fileNames["GJets0p4_400to600"] = "tree_GJets_DR-0p4_HT-400to600_MC2018.root";
        fileNames["GJets0p4_600toInf"] = "tree_GJets_DR-0p4_HT-600toInf_MC2018.root";
	
        fileNames["GJets_100to200"] = "tree_GJets_HT-100to200_MC2018.root";
        fileNames["GJets_200to400"] = "tree_GJets_HT-200to400_MC2018.root";
        fileNames["GJets_400to600"] = "tree_GJets_HT-400to600_MC2018.root";
        fileNames["GJets_600toInf"] = "tree_GJets_HT-600toInf_MC2018.root";

        fileNames["Other_WWTo1L1Nu2Q"] = "tree_WWTo1L1Nu2Q_MC2018.root";
        fileNames["Other_WWTo2L2Nu"] = "tree_WWTo2L2Nu_MC2018.root";
        fileNames["Other_WWZ"] = "tree_WWZ_MC2018.root";
        //fileNames["Other_WZTo1L1Nu2Q"] = "tree_WZTo1L1Nu2Q_MC2018.root";
        ...
        fileNames["Other_ZZTo2Q2Nu"] = "tree_ZZTo2Q2Nu_MC2018.root";
        ...
        fileNames["Other_ST_s"] = "tree_ST_s-channel_MC2018.root";
        //fileNames["Other_ST_t_antitop"] = "tree_ST_t-channel_antitop_MC2018.root";
        //fileNames["Other_ST_t_top"] = "tree_ST_t-channel_top_MC2018.root";
        fileNames["Other_ST_tW_antitop"] = "tree_ST_tW_antitop_MC2018.root";
        fileNames["Other_ST_tW_top"] = "tree_ST_tW_top_MC2018.root";
